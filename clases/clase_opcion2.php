...
class Opcion2 {
	...
	public function insertar($nombre) {
		...
		$sql = sprintf("INSERT INTO opciones2(nombre, estado, fecha_registro) VALUES('%s', 1, CURDATE())", $nombre);
	...
	public function actualizar($id, $nombre) {
		...
		$sql = sprintf("UPDATE opciones2 SET nombre='%s' WHERE id='%d'", $nombre, $id);
	...
	public function desactivar($id) {
		...
		$sql = sprintf("UPDATE opciones2 SET estado=0 WHERE id='%d'", $id);
