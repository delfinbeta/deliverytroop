...
if(!$nombre_imagen == "") {
  ...
  if(!$error) {
    ...
    while($hotel->imagen_existe($nombre_imagen, 0)) {
...
if(!$error) {
	if($hotel->insertar($nombre, $zipcode, $ciudad, $direccion, $nombre_imagen)) {
		echo json_encode(array("error" => false, "mensaje" => 'Hotel Agregado'));
	} else {
