...
if(isset($_GET['id'])) { $id_opcion2 = $_GET['id']; } else { $id_opcion2 = 0; }
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="container-fluid">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-9 col-md-10 main">
				...
				<h1>Option 2</h1>
				<ol class="breadcrumb">
				  <li><a href="index.php">Options 2</a></li>
				  <li class="active">Option 2</li>
				</ol>
				<?php if($opcion2->datos($id_opcion2)) { ?>
              ...
              <input type="hidden" name="id" value="<?=$id_opcion2?>" />
              <div class="row">
              	<div class="col-xs-12 form-group has-feedback">
            			<label for="nombre">Name:</label>
            			<div class="input-group">
            				<div class="input-group-addon"><i class="fa fa-user"></i></div>
            				<input type="text" class="form-control" name="nombre" placeholder="Nombre" value="<?=$opcion2->nombre?>" aria-describedby="bloqueErrorNombre"  />
            			</div>
        ...
        <div class="alert alert-danger" role="alert">
          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
          <i class="fa fa-times"></i> Error: <?=$opcion2->error?>
        </div>
        <?php } ?>
			</div>
		</div>
