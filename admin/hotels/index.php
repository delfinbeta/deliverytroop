...
// Listar Hoteles
$listado = $hotel->listado('', 1);
$total = $hotel->total_listado('', 1);
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="col-sm-9 col-md-10 main">
				...
				<div class="panel panel-default">
				  <div class="panel-heading">
				  	<div class="pull-left">Hotel list</div>
				  	<div class="pull-right"><a href="add.php" class="btn btn-success"><i class="fa fa-plus"></i> Add Hotel</a></div>
              ...
              <?php if($_GET['m'] == "I") { echo "Hotel added"; }
              			if($_GET['m'] == "M") { echo "Hotel edited"; }
              			if($_GET['m'] == "E") { echo "Hotel deleted"; } ?>
            </div>
            <?php } ?>
                  ...
                  <th width="26">&nbsp;</th>
					    ...
					    <tbody>
					    	<?php foreach($listado as $registro) {
					    					...
					    					else { $ruta_img = $GLOBALS['domain_root']."/archivos_hoteles/".$registro->imagen; } ?>
	              <tr>
	                <td>
	                	<a href="hotel.php?id=<?=$registro->obtener_id()?>"><img src="<?=$ruta_img?>" width="100" alt="<?=$registro->nombre?>" title="<?=$registro->nombre?>" /></a>
	                </td>
	                <td><a href="hotel.php?id=<?=$registro->obtener_id()?>"><?=$registro->nombre?></a></td>
	                <td><?=$registro->zipcode?></td>
	                <td><?=$registro->ciudad?></td>
	                <td><a href="hotel.php?id=<?=$registro->obtener_id()?>"><i class="icono fa fa-file-text-o"></i></a></td>
