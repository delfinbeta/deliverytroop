...
// Listar Contenidos
$listado = $contenido->listado(1);
$total = $contenido->total_listado(1);
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-9 col-md-10 main">
				...
				<div class="panel panel-default">
				  <div class="panel-heading">
				  	<div class="pull-left">Content list</div>
				  	<div class="pull-right"><a href="add.php" class="btn btn-success"><i class="fa fa-plus"></i> Add Content</a></div>
              ...
              <?php if($_GET['m'] == "I") { echo "Content added"; }
              			if($_GET['m'] == "M") { echo "Content edited"; }
              			if($_GET['m'] == "E") { echo "Content deleted"; } ?>
            </div>
            <?php } ?>
            <div id="error" class="alert alert-danger hidden" role="alert">
              ...
              <i class="fa fa-times"></i> <span id="msjError">Error</span>
	              ...
	              <tr>
	                <td><a href="content.php?id=<?=$registro->obtener_id()?>"><?=$registro->nombre?></a></td>
	                <td><a href="content.php?id=<?=$registro->obtener_id()?>"><i class="icono fa fa-file-text-o"></i></a></td>
