		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-9 col-md-10 main">
				...
				<div class="panel panel-default">
				  <div class="panel-heading">
				  	<div class="pull-left">Option 1 list</div>
				  	<div class="pull-right"><a href="add.php" class="btn btn-success"><i class="fa fa-plus"></i> Add Option 1</a></div>
            ...
            <div id="error" class="alert alert-danger hidden" role="alert">
              ...
              <i class="fa fa-times"></i> <span id="msjError">Error</span>
	              ...
	              <tr>
	                <td><a href="option1.php?id=<?=$registro->obtener_id()?>"><?=$registro->nombre?></a></td>
	                <td><a href="option1.php?id=<?=$registro->obtener_id()?>"><i class="icono fa fa-file-text-o"></i></a></td>
