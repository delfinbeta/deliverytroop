		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-9 col-md-10 main">
				...
				<div class="panel panel-default">
				  <div class="panel-heading">Add Zipcode</div>
              ...
              <div class="row">
              	<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
            		...
            		<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
            			<label for="codigo" class="sr-only">Zipcode:</label>
            			<div class="input-group">
            				<input type="text" class="form-control" name="codigo" placeholder="Zipcode" aria-describedby="bloqueErrorZipcode"  />
