...
// Listar Zipcodes
$listado = $zipcode->listado(1);
$total = $zipcode->total_listado(1);
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-9 col-md-10 main">
				...
				<div class="panel panel-default">
				  <div class="panel-heading">
				  	<div class="pull-left">Zipcode list</div>
				  	<div class="pull-right"><a href="add.php" class="btn btn-success"><i class="fa fa-plus"></i> Add Zipcode</a></div>
              ...
              <?php if($_GET['m'] == "I") { echo "Zipcode added"; }
              			if($_GET['m'] == "M") { echo "Zipcode edited"; }
              			if($_GET['m'] == "E") { echo "Zipcode deleted"; } ?>
            </div>
            <?php } ?>
            <div id="error" class="alert alert-danger hidden" role="alert">
              ...
              <i class="fa fa-times"></i> <span id="msjError">Error</span>
	              ...
	              <tr>
	                <td><a href="zipcode.php?id=<?=$registro->obtener_id()?>"><?=$registro->codigo?></a></td>
	                <td><?=$registro->nombre?></td>
	                <td><a href="zipcode.php?id=<?=$registro->obtener_id()?>"><i class="icono fa fa-file-text-o"></i></a></td>
